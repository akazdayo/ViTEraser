...
def get_args_parser():
    ...
    parser.add_argument('--load_pretrain_ignore_encoder', action='store_true')
    parser.add_argument('--pretrained_encoder', type=str, default='')
    parser.add_argument('--pretrained_decoder', type=str, default='')
    parser.add_argument('--pretrained_vgg16', type=str, default='')
    parser.add_argument('--encoder', default='swinv2', type=str)
